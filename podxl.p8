...
function game_update()
  ...
  if start_counter == 0 then
    ...
    --camera
    cam[1].x = lerp(cam[1].x, p1.x-32, 0.05)
    cam[1].y = lerp(cam[1].y, p1.y-64, 0.05)
    cam[2].x = lerp(cam[2].x, p2.x-96, 0.05)
    cam[2].y = lerp(cam[2].y, p2.y-64, 0.05)
  end
...
function game_draw()
  for m = 1,2 do
    ...
    drawshield(cam[m].x+3,cam[m].y,p1)
    drawshield(cam[m].x+30,cam[m].y+127,p2)
    ...
    if maintimer >= 0 and start_counter == 0 then
      ...
      if x < cam[m].x+4 then x = cam[m].x+4 elseif x > cam[m].x+123 then x = cam[m].x+123 end
      if y < cam[m].y+13 then y = cam[m].y+13 elseif y > cam[m].y+114 then y = cam[m].y+114 end
  ...
  clip()
  for a = 1,3 do
   ui(cam[2].x+3,cam[2].y+2,car[a],p1)
  end
  for a = 4,6 do
   ui(cam[2].x-2,cam[2].y+119,car[a],p2)
  end
  if p1.winner == true then
    local y = 62
    rectfill(cam[2].x,cam[2].y+y-1,cam[2].x+128,cam[2].y+y+5,p1.clr)
    spr(85,cam[2].x+36,cam[2].y+y)
    spr(70,cam[2].x+44,cam[2].y+y)
    spr(86,cam[2].x+52,cam[2].y+y,5,1)
  end
  if p2.winner == true then
    local y = 62
    rectfill(cam[2].x,cam[2].y+y-1,cam[2].x+128,cam[2].y+y+5,p2.clr)
    spr(85,cam[2].x+36,cam[2].y+y)
    spr(71,cam[2].x+44,cam[2].y+y)
    spr(86,cam[2].x+52,cam[2].y+y,5,1)
  end
...
function _draw()
  ...
  if game_start == true then
   ...
   print(stat(1),cam[2].x+20,cam[2].y+20,11)
end
